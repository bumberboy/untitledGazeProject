...
//         let x = eyesRect[0] + eyesRect[2] / 2;
//         let y = eyesRect[1] + eyesRect[3] / 2;
//
//         const video = $('#inputVideo');
//
//         x = (x / video.width()) * 2 - 1;
//         y = (y / video.height()) * 2 - 1;
//
//         const rectWidth = eyesRect[2] / video.width();
//         const rectHeight = eyesRect[3] / video.height();
